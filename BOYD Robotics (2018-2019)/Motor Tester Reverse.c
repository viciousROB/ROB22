...
#pragma config(Motor,  port3,           C,             tmotorVex393TurboSpeed_MC29, openLoop)
...
while(1==1)
{
displayLCDCenteredString(nLine, pzString);
nline=validateLongAddress(SensorValue[VAR]);
pzString=validateWordAddress(SensorValue[VAR2]);
}
